function calculation(event) {
  ...
  if (userInputNumber < 11) {
    alert("Please enter the number greater then 10");
  } else {
    document.getElementById("userEnteredNumber").firstChild.nodeValue =
      userInputNumber;

    buy1st = (userInputNumber * (0.909090909 / 100)).toFixed(4);
    buy2nd = (userInputNumber * (1.36363636 / 100)).toFixed(4);
    buy3rd = (userInputNumber * (2.86363636 / 100)).toFixed(4);
    buy4th = (userInputNumber * (5.90909091 / 100)).toFixed(4);
    buy5th = (userInputNumber * (12.2090909 / 100)).toFixed(4);
    buy6th = (userInputNumber * (25.1090909 / 100)).toFixed(4);
    buy7th = (userInputNumber * (51.6363636 / 100)).toFixed(4);
