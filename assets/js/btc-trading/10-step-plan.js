function calculation(event) {
  ...
  if (userInputNumber < 70) {
    alert("Please enter the number greater then 69");
  } else {
    document.getElementById("userEnteredNumber").firstChild.nodeValue =
      userInputNumber;

    buy1st = (userInputNumber * (0.0757142857142857 / 100)).toFixed(4);
    buy2nd = (userInputNumber * (0.1571428571428571 / 100)).toFixed(4);
    buy3rd = (userInputNumber * (0.3285714285714286 / 100)).toFixed(4);
    buy4th = (userInputNumber * (0.6814285714285714 / 100)).toFixed(4);
    buy5th = (userInputNumber * (1.401428571428571 / 100)).toFixed(4);
    buy6th = (userInputNumber * (2.885714285714286 / 100)).toFixed(4);
    buy7th = (userInputNumber * (5.927142857142857 / 100)).toFixed(4);
    buy8th = (userInputNumber * (12.17857142857143 / 100)).toFixed(4);
    buy9th = (userInputNumber * (25.01428571428571 / 100)).toFixed(4);
    buy10th = (userInputNumber * (51.35 / 100)).toFixed(4);
