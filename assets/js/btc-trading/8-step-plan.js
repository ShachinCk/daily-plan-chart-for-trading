function calculation(event) {
  ...
  if (userInputNumber < 16) {
    alert("Please enter the number greater then 15");
  } else {
    document.getElementById("userEnteredNumber").firstChild.nodeValue =
      userInputNumber;

    buy1st = (userInputNumber * (0.33125 / 100)).toFixed(4);
    buy2nd = (userInputNumber * (0.68125 / 100)).toFixed(4);
    buy3rd = (userInputNumber * (1.4 / 100)).toFixed(4);
    buy4th = (userInputNumber * (2.875 / 100)).toFixed(4);
    buy5th = (userInputNumber * (5.90625 / 100)).toFixed(4);
    buy6th = (userInputNumber * (12.19375 / 100)).toFixed(4);
    buy7th = (userInputNumber * (25.075 / 100)).toFixed(4);
    buy8th = (userInputNumber * (51.5375 / 100)).toFixed(4);
