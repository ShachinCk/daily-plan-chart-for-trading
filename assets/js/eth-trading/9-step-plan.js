function calculation(event) {
  ...
  if (userInputNumber < 34) {
    alert("Please enter the number above 33");
  } else {
    document.getElementById("userEnteredNumber").firstChild.nodeValue =
      userInputNumber;

    buy1st = (userInputNumber * (0.0294117647058824 / 100)).toFixed(4);
    buy2nd = (userInputNumber * (0.0647058823529412 / 100)).toFixed(4);
    buy3rd = (userInputNumber * (0.1352941176470588 / 100)).toFixed(4);
    buy4th = (userInputNumber * (0.2794117647058824 / 100)).toFixed(4);
    buy5th = (userInputNumber * (0.5764705882352941 / 100)).toFixed(4);
    buy6th = (userInputNumber * (1.185294117647059 / 100)).toFixed(4);
    buy7th = (userInputNumber * (2.435294117647059 / 100)).toFixed(4);
    buy8th = (userInputNumber * (5.005882352941176 / 100)).toFixed(4);
    buy9th = (userInputNumber * (10.28823529411765 / 100)).toFixed(4);
