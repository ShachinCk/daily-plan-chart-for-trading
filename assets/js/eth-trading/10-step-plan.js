function calculation(event) {
  ...
  if (userInputNumber < 70) {
    alert("Please enter the number above 69");
  } else {
    document.getElementById("userEnteredNumber").firstChild.nodeValue =
      userInputNumber;

    buy1st = (userInputNumber * (0.0142857142857143 / 100)).toFixed(4);
    buy2nd = (userInputNumber * (0.0314285714285714 / 100)).toFixed(4);
    buy3rd = (userInputNumber * (0.0657142857142857 / 100)).toFixed(4);
    buy4th = (userInputNumber * (0.1357142857142857 / 100)).toFixed(4);
    buy5th = (userInputNumber * (0.28 / 100)).toFixed(4);
    buy6th = (userInputNumber * (0.5757142857142857 / 100)).toFixed(4);
    buy7th = (userInputNumber * (1.182857142857143 / 100)).toFixed(4);
    buy8th = (userInputNumber * (2.431428571428571 / 100)).toFixed(4);
    buy9th = (userInputNumber * (4.997142857142857 / 100)).toFixed(4);
    buy10th = (userInputNumber * (10.28571428571429 / 100)).toFixed(4);
    ...
    tbuy9th = (buy9th * 5).toFixed(4);
    tbuy10th = (buy10th * 5).toFixed(4);
    ...
    win9th = (buy9th * 9.75).toFixed(4);
    win10th = (buy10th * 9.75).toFixed(4);
    ...
    document.getElementById("b10th").firstChild.nodeValue = buy10th;
    ...
    document.getElementById("tb9th").firstChild.nodeValue = tbuy9th;
    document.getElementById("tb10th").firstChild.nodeValue = tbuy10th;
    ...
    document.getElementById("w10th").firstChild.nodeValue = win10th;
    ...
    document.getElementById("n10th").firstChild.nodeValue = net10th;
    ...
    document.getElementById("c10th").firstChild.nodeValue = cost10th;
